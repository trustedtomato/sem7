...
def load_ptb_data(data_path='data/ptb-xl/'):
    ...
    train_data = load_raw_data(ptb_df_train[0:100], sampling_rate, data_path)
    return preprocess(train_data, sampling_rate).copy()
...
if __name__ == '__main__':
    ...
    train_data = load_ptb_data(data_path=ptb_path)
